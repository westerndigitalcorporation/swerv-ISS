...
CsRegs<URV>::defineMachineRegs()
{
  ...
  regs_.at(PMPADDR0_CSR) = Reg("pmpaddr0", PMPADDR0_CSR, true, 0);
  regs_.at(PMPADDR1_CSR) = Reg("pmpaddr1", PMPADDR1_CSR, true, 0);
  regs_.at(PMPADDR2_CSR) = Reg("pmpaddr2", PMPADDR2_CSR, true, 0);
  regs_.at(PMPADDR3_CSR) = Reg("pmpaddr3", PMPADDR3_CSR, true, 0);
  regs_.at(PMPADDR4_CSR) = Reg("pmpaddr4", PMPADDR4_CSR, true, 0);
  regs_.at(PMPADDR5_CSR) = Reg("pmpaddr5", PMPADDR5_CSR, true, 0);
  regs_.at(PMPADDR6_CSR) = Reg("pmpaddr6", PMPADDR6_CSR, true, 0);
  regs_.at(PMPADDR7_CSR) = Reg("pmpaddr7", PMPADDR7_CSR, true, 0);
  regs_.at(PMPADDR8_CSR) = Reg("pmpaddr8", PMPADDR8_CSR, true, 0);
  regs_.at(PMPADDR9_CSR) = Reg("pmpaddr9", PMPADDR9_CSR, true, 0);
  regs_.at(PMPADDR10_CSR) = Reg("pmpaddr10", PMPADDR10_CSR, true, 0);
  regs_.at(PMPADDR11_CSR) = Reg("pmpaddr11", PMPADDR11_CSR, true, 0);
  regs_.at(PMPADDR12_CSR) = Reg("pmpaddr12", PMPADDR12_CSR, true, 0);
  regs_.at(PMPADDR13_CSR) = Reg("pmpaddr13", PMPADDR13_CSR, true, 0);
  regs_.at(PMPADDR14_CSR) = Reg("pmpaddr14", PMPADDR14_CSR, true, 0);
  regs_.at(PMPADDR15_CSR) = Reg("pmpaddr15", PMPADDR15_CSR, true, 0);
